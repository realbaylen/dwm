...
static const char *rsscmd[]  = { "sfeed_menu", NULL };
static const char *wallpapercmd[]  = { "set_wallpaper", NULL };
static const char *musiccmd[]  = { "mu", NULL };
static const char *killxorgcmd[]  = { "killall" "Xorg", NULL };
static const char *passcmd[]  = { "dmenu_pass", NULL };
